										...
										<FORM id="pageForm" name="customerForm"
											...
											<TBODY>
												<TR>
													...
													<TD>客户名称：</TD>
													<TD>
														<input type="hidden" name="customer.cust_id" id="cust_id" value="">
														<INPUT class=textbox name="cust_name"
															   style="WIDTH: 80px" maxLength=50 id="cust_name" value="${param['cust_name']}">
